...
{?>
   ...
   <?php } ?>
            ...
            <tr class="details">
                ...
                <td>
                  <?php echo htmlentities($row['cfee']);?>
                </td>
            </tr>
