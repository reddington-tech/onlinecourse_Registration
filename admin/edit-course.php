...
$ret=mysqli_query($con,"update course set courseCode='$coursecode',courseName='$coursename',courseUnit='$courseunit',cfee='$cfee',noofSeats='$seatlimit',updationDate='$currentTime' where id='$id'");
if($ret)
{
...
<div class="form-group">
    <label for="cfee">Course Name  </label>
    <input type="text" class="form-control" id="cfee" name="cfee" placeholder="Course fee" value="<?php echo htmlentities($row['cfee']);?>" required />
  </div>
