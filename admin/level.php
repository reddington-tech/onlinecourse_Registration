...
{
  $_SESSION['msg']="Error : Module not created";
}
}
if(isset($_GET['del']))
      {
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="department">Add Module  </label>
    <input type="text" class="form-control" id="level" name="level" placeholder="Module" required />
  </div>
