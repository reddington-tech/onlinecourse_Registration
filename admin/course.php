...
$ret=mysqli_query($con,"insert into course(courseCode,courseName,courseUnit,cfee,noofSeats) values('$coursecode','$coursename','$courseunit','$cfee','$seatlimit')");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="cfee" name="cfee" placeholder="Course Fee" required />
  </div> 
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['cfee']);?></td>
